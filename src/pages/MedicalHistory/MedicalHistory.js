							...
							<div class="card-body p-5">
								...
								<table class="table table-bordered">
									...
									<tbody>
										<tr>
											...
											<td><input type="pin" class="form-control" maxlength="2" size="2"/></td>
										...
										<tr>
											...
											<td><input type="date" class="form-control"/></td>
											<td><input type="pin" class="form-control" maxlength="2" size="2"/></td>
											<td>Other:<input type="text" class="form-control"/></td>
											<td>
												<input class="form-check-input" type="checkbox" id="gridCheck"/>
											</td>
											<td>
								...
								<table class="table table-bordered">
									...
									<tbody>
										<tr>
											<td><input type="name" class="form-control"/></td>
											<td><input type="pin" class="form-control" maxlength="6" size="6"/></td>
								...
								<table class="table table-bordered">
									...
									<tbody>
										<tr>
											<td><input type="name" class="form-control"/></td>
											<td><input type="text" class="form-control" size="6"/></td>
											<td><input type="text" class="form-control" maxlength="2" size="2"/></td>
											<td><input type="name" class="form-control"/></td>
											<td>
												<input class="form-check-input" type="checkbox" id="gridCheck"/>
												<label class="form-check-label" for="Breath" id="gridLabel">
													Y
												</label>
												<input class="form-check-input" type="checkbox" id="gridCheck"/>
												<label class="form-check-label" for="Breath" id="gridLabel">
								...
								<div class="col-12">
									<button type="submit" class="btn btn-primary" formaction="aqtest.html">Next</button>
								</div>
							</div>
						</div>
					</div>
