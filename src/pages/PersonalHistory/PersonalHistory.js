						...
						<div className="card bg-white">
							<div className="card-body p-5">
								...
								<form className="row g-3">
									...
									<p
										className="spacing3">
										<span className="fontapply">Birth weight&nbsp;</span><u><span
												className="fontapply">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></u><span
											className="fontapply">&nbsp;</span><span
											className="fontapply">lbs&nbsp;</span><u><span
												className="fontapply">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></u><span
											className="fontapply">&nbsp;</span><span
											className="fontapply">oz</span><span
											className="fontapply">&nbsp;&nbsp;&nbsp;</span><span
											className="fontapply">Length&nbsp;</span><u><span
												className="fontapply">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></u><span
											className="fontapply">&nbsp;</span><span
											className="fontapply">in. 	&#40;if
											known		&#41;</span><span
											className="fontapply">&nbsp;&nbsp;</span><span
											className="fontapply">Head circumference</span><span
											className="fontapply">&nbsp;&nbsp;</span><span
											className="fontapply">______ in. 	&#40;if known		&#41;</span><span
											className="fontapply">&nbsp;&nbsp;&nbsp;&nbsp;</span><span
											className="fontapply">Apgar Scores 	&#40;if known		&#41;:</span><span
											className="fontapply">&nbsp;&nbsp;</span><span
											className="fontapply">______ at 1 min</span><span
											className="fontapply">&nbsp;&nbsp;</span><span
											className="fontapply">______ at 5 min</span>
									</p>
									<p
										className="spacing5">
										<strong><span className="fontapply">&nbsp;</span></strong>
									</p>
									<p className="spacing4">
										<strong><u><span className="fontapply">Newborn
													period</span></u></strong><strong><span
									...
									<p className="Checkbox-space"><span
											className="fontapply">Was the
											child healthy as a newborn?&nbsp;</span><input type="checkbox"
											name="Check18"/><strong><span
												className="fontapply">&nbsp;Yes</span></strong><strong><span
												className="fontapply">&nbsp;&nbsp;</span></strong><input
											type="checkbox" name="Check18"/><strong><span
												className="fontapply">&nbsp;No</span></strong><span
											className="fontapply">&nbsp;&nbsp;&nbsp;</span><span
											className="fontapply">If not, ****** describe the problems
											and
											treatment:</span></p>
									<p className="Checkbox-space"><span
											className="fontapply">&nbsp;</span></p>
									<p className="spacing25">
										<span className="spacing26"><img
												src="https://myfiles.space/user_files/151279_20fec66591f04fb9/1678878548_developmental-history-form/1678878548_developmental-history-form-3.png"
												width="715" height="8" alt=""
												className="spacing24"/></span><span
											className="fontapply">&nbsp;</span>
									</p>
									<p className="Checkbox-space"><span
											className="spacing28"><img
												src="https://myfiles.space/user_files/151279_20fec66591f04fb9/1678878548_developmental-history-form/1678878548_developmental-history-form-4.png"
												width="715" height="6" alt=""
												className="spacing24"/></span><span
											className="fontapply">&nbsp;</span></p>
									<p
										className="boxpadding">
										<span className="fontapply">Was the child born with any birth
											defects?</span><span
											...
											className="fontapply">&nbsp;&nbsp;&nbsp;</span><span
											className="fontapply">If yes, explain:
									...
									<p
										...
										<span
											className="font2"><img
												src="https://myfiles.space/user_files/151279_20fec66591f04fb9/1678878548_developmental-history-form/1678878548_developmental-history-form-5.png"
												width="708" height="2" alt=""
												className="spacing24"/></span><span
											className="fontapply">&nbsp;</span>
									</p>
									<p
									...
									<p
										className="boxpadding">
										<span className="fontapply">Did the ***** require treatment in
											a
											******* intensive care
											unit?&nbsp;</span><input type="checkbox" name="Check18"/><span
											className="fontapply">&nbsp;Yes 	&#40;for _________
											days		&#41;</span><span
											className="fontapply">&nbsp;&nbsp;</span><input
											type="checkbox" name="Check18"/><span
											className="fontapply">&nbsp;No</span><span
									...
									<p
									        className="boxpadding">
										<span className="fontapply">Did the baby require any special
											care
											immediately after
											birth?</span><span
											className="fontapply">&nbsp;&nbsp;</span><input
									...
									<p className="Checkbox-space"><input type="checkbox"
											...
											className="fontapply">&nbsp;&nbsp;</span><span
											className="fontapply">__________________________________________________________________</span><span
											className="spacing38">&nbsp;</span><span
											className="Checkbox2">&nbsp;</span><span
											className="fontapply">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
									</p>
									<p
									...
									<p className="Checkbox-space"><span
											...
											notice *** delays ** the client&rsquo;s social
									...
									<p className="Checkbox-space"><span
											...
											className="fontapply">&nbsp;No</span><span
											className="fontapply">&nbsp;&nbsp;&nbsp;</span><span
											className="fontapply">________________________________________</span>
									</p>
									<p className="Checkbox-space"><span
									...
									<p className="Checkbox-space"><span
											className="Checkbox2">&nbsp;</span></p>
									<p className="spacing6">
										<span className="fontapply">**** appropriate eye
											contact?</span><span
									...
									<p className="Checkbox-space"><span
											...
											first four ***** of life, were *** special problems noted in the following
											areas?&nbsp;</span></p>
									<p className="spacing6">
										<em><span className="fontapply">** yes, please describe
												below:</span></em>
									</p>
									<p className="spacing6">
									...
									<p className="Checkbox-space"><span
											className="fontapply">&nbsp;</span></p>
									<p className="spacing6">
										<span className="fontapply">********** from parents</span><span
									...
									<p className="Checkbox-space"><strong><span
												className="fontapply">Speech and ********
												Development</span></strong></p>
									<p className="Checkbox-space"><strong><span
												className="fontapply">&nbsp;</span></strong></p>
									<p className="Checkbox-space"><span
									...
									<p className="Checkbox-space"><span
											className="Checkbox2">&nbsp;</span><em><span
												...
												yes, ****** specify:</span></em><span
											className="fontapply">&nbsp;__________________________________________________________________</span>
									</p>
									<p className="Checkbox-space"><span
											className="fontapply">&nbsp;</span></p>
									<p className="Checkbox-space"><span
											className="fontapply">Did the
											following ********** develop on time? ****** specify age
												&#40;year/month		&#41;.</span></p>
									<p className="Checkbox-space"><span
											className="Checkbox2">&nbsp;</span></p>
									<p className="spacing6">
										<span className="fontapply">Show interest **
											...
											className="fontapply">&nbsp;No</span><span
											className="fontapply">&nbsp;&nbsp;&nbsp;</span><span
											className="fontapply">__________________________________</span>
									</p>
									<p className="Checkbox-space"><span
											className="fontapply">&nbsp;</span></p>
									<p className="Checkbox-space"><span
									...
									<p className="Checkbox-space"><span
											...
											words&nbsp;</span><em><span className="fontapply">	&#40;by 6-**
												months		&#41;</span></em><span
									...
									<p className="spacing6">
										<em><span className="fontapply">If yes, please
											...
											className="fontapply">&nbsp;________________________________________________________________________</span>
									</p>
									<p className="Checkbox-space"><span
											className="fontapply">&nbsp;</span></p>
									<p className="Checkbox-space"><span
											className="fontapply">Did the
											following milestones develop ** time?&nbsp;</span><em><span
									...
									<p className="spacing31"><span
											className="Checkbox2">&nbsp;</span><span
											className="spacing17">Turn over 	&#40;** 6
											months		&#41;</span><span
											...
											className="spacing17">__________________________________</span>
									</p>
									<p className="Checkbox-space"><span
											className="fontapply">&nbsp;</span></p>
									<p className="Checkbox-space"><span
									...
									<p className="Checkbox-space"><span
											...
											the ****** toilet trained?</span><span
											className="spacing55">&nbsp;</span><span
											className="fontapply">Days: _______________</span><span
											className="spacing56">&nbsp;</span><span
											className="fontapply">Nights:_______________</span></p>
									<p className="Checkbox-space"><span
											className="Checkbox2">&nbsp;</span></p>
									<p className="spacing6">
										<span className="fontapply">&nbsp;</span>
									...
									<p className="spacing6">
										<span className="fontapply">Did bed-wetting occur after ******
									...
									<p className="spacing6">
										<span className="fontapply">*** bed-soiling ***** after toilet
											training?</span><span
											className="fontapply">&nbsp;&nbsp;</span><input
											type="checkbox" name="Check18"/><span
											className="fontapply">&nbsp;Yes</span><span
									...
									<p className="Checkbox-space"><span
											...
											className="Checkbox2">&nbsp;</span><span
											className="Checkbox2">&nbsp;</span><span
											className="fontapply">________________________________________________</span>
									</p>
									<p className="spacing6">
										<span className="fontapply">&nbsp;</span>
									</p>
									...
									<p className="spacing31"><strong><span
											...
											****
											...
											throwing objects in his/her **** time or speaking in **** sentences for many
											******
											and then just stopped
											speaking altogether or began using only ****** words
									...
									<p
										...
										<span className="fontapply">Social functioning</span><span
											...
											______ months; Explain:</span><span
											className="fontapply">&nbsp;&nbsp;</span><span
											className="fontapply">_________________________________</span>
									</p>
									<p className="spacing18">
										<span className="spacing19">&nbsp;</span><span
											className="spacing20">&nbsp;</span><span
											className="fontapply">&nbsp;&nbsp;</span><span
											className="fontapply">____________________________________________________________________</span>
									</p>
									<p className="spacing18">
										<span className="fontapply">&nbsp;</span>
									</p>
									<p
										className="spacing21">
										<span className="fontapply">****** / language</span><span
											className="fontapply">&nbsp;&nbsp;</span><span
											className="spacing59">&nbsp;</span><span
											className="fontapply">&nbsp;&nbsp;</span><input
											type="checkbox" name="Check53"/><span
											className="fontapply">&nbsp;Age ** loss:
											______ months; Explain:</span><span
											className="fontapply">&nbsp;&nbsp;</span><span
											className="fontapply">_________________________________</span>
									</p>
